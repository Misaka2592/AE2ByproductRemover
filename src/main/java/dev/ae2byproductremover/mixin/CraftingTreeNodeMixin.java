...
public abstract class CraftingTreeNodeMixin {
    ...
    private IPatternDetails ae2byproductremover$selectOutputForRecursion(IPatternDetails pattern) {
        // Check the same output view used for planning, regardless of its encoded slot.
